...
const generateHTMLContent = ({ width, height, mode, orientation }) => {
  ...
  return `
      ...
      <body>
        <div class="container">
          <img src="https://raw.githubusercontent.com/prateek-workspace/TodoApp/refs/heads/main/public/logo512.png" class="logo" alt="App Logo" />
          <div class="app-name">
        ...
        <div class="attribution">
          ...
          <div class="attribution-box">
            <img src="https://avatars.githubusercontent.com/u/85953204?v=4" alt="@prateek-workspace" />
            <span>@prateek-workspace</span>
          </div>
        </div>
      </body>
    </html>
