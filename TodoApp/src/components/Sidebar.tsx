  ...
  return (
    <Container>
      ...
      >
        ...
        <MenuLink to="https://github.com/prateek-workspace/TodoApp">
        ...
        <MenuLink to="https://github.com/prateek-workspace/TodoApp/issues/new">
          <StyledMenuItem>
        ...
        <MenuLink to="https://www.buymeacoffee.com/prateek-workspace">
        ...
        <ProfileOptionsBottom>
          ...
          <CreditsContainer translate="no">
            ...
            <a
              ...
              href="https://github.com/prateek-workspace"
            >
              prateek-workspace
            </a>
          </CreditsContainer>
